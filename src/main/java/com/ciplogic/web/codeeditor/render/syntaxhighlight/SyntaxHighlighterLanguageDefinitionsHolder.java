...
public class SyntaxHighlighterLanguageDefinitionsHolder extends LanguageDefinitionsHolder {
    public SyntaxHighlighterLanguageDefinitionsHolder() {
        ...
        addLanguage("HTML 4", "html", ProgrammingLanguage.HTML);
